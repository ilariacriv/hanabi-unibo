/**
 * Il package impl (Simplified-JSON) definisce classi java per una gestione semplificata di oggetti impl. <br>
 ...
 * Il package impl implementa una versione semplificata prevedendo che i valori possano essere solo oggetti, array o stringhe. <br>
